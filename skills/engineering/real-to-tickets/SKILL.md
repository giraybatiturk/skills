...
The issue tracker and triage label vocabulary should have been provided to you. If not, tell the user to run `/real-setup`.
...
Publish the approved tickets. **How** depends on the tracker `/real-setup` configured; the tickets are the same either way, only the shape of the blocking edges changes:

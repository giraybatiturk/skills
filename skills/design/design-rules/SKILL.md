...
- Design/UI audits go through **`/design-audit`** (it orchestrates the installed skills: critique loop, refactoring UI, component registry, UX writing, visual verification).

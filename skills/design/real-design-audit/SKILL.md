...
For a large or critical screen, or a batch audit: `/real-design-audit <screen> --multi` fans out through a Workflow. Without the flag it's a single agent running the same flow serially.

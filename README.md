...
`/real-grill` and `/real-research` are adapted from [mattpocock/skills](https://github.com/mattpocock/skills) (MIT). The gate and the audits are what I added on top: the parts an engineering-only flow leaves to production to discover.
...
- **0.2.0** (2026-09-07): 13 skills from mattpocock/skills under the engineering flow; MIT.
